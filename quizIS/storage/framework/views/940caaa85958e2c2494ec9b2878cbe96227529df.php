...
<div class="page-sidebar-wrapper">
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu"
            ...
            <li class="<?php echo e($request->segment(1) == 'etapas' ? 'active' : ''); ?>">

                <a href="<?php echo e(route('etapas.index')); ?>">
                    <i class="fa fa-book" aria-hidden="true"
                    ></i>
                    <span class="title"><?php echo app('translator')->getFromJson('quickadmin.etapa.title'); ?></span>
                </a>
            </li>
