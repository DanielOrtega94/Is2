...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('tests/select/{id}',['uses' => 'TestsController@select', 'as' => 'tests.select']);
    ...
    Route::post('questions/select',['uses' => 'QuestionsController@select', 'as' => 'questions.select']);
    ...
    Route::resource('miempresa','MiempresaController');
