...
class Question extends Model
{
    ...
    protected $fillable = ['question_text', 'ponderation', 'answer_explanation', 'more_info_link', 'topic_id','etapa_id','inicial'];
    ...
    {
        return $this->belongsTo(Topic::class, 'etapa_id')->withTrashed();
    }
