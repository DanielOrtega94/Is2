...
class TopicsController extends Controller
{
    ...
    public function index()
    {
        $topics = Topic::all();
        $etapas = etapa::all();
        return view('topics.index', compact('topics','etapas'));
    }
    ...
    {
        #sirve para crear los topicos juntos a sus etapas
        #principalmente para mostrar como lista los eleemtnos
          $relations = [
            'etapas' => etapa::get()->pluck('Nombre', 'Nombre')->prepend('Please select', ''),
        ];
