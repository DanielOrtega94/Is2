...
CREATE TABLE IF NOT EXISTS `laraquiz`.`questions` (
  ...
  `code_snippet` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `laraquiz`.`results` (
  ...
  PRIMARY KEY (`id`, `empresa_id`, `user_id`, `topico`),
...
-- -----------------------------------------------------
-- Table `laraquiz`.`empresa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `laraquiz`.`empresa` ;

CREATE TABLE IF NOT EXISTS `laraquiz`.`empresa` (
